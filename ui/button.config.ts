...
export default tv({
  ...
  variants: {
    ...
    color: {
      red: {
        ...
        icon: "bg-cabaret-200",
        activeClass:
          "text-red-500 hover:text-red-500/90 dark:text-red-400 dark:hover:text-red-400/90",
      },
      orange: {
        ...
        icon: "bg-pumpkin-200",
        activeClass:
          "text-orange-500 hover:text-orange-500/90 dark:text-orange-400 dark:hover:text-orange-400/90",
      },
      green: {
        ...
        icon: "bg-keppel-200",
        activeClass:
          "text-green-500 hover:text-green-500/90 dark:text-green-400 dark:hover:text-green-400/90",
      },
      blue: {
        ...
        activeClass:
          "text-blue-500 hover:text-blue-500/90 dark:text-blue-400 dark:hover:text-blue-400/90",
      },
      purple: {
        ...
        activeClass:
          "text-purple-500 hover:text-purple-500/90 dark:text-purple-400 dark:hover:text-purple-400/90",
      },
      black: {
        textColor:
          "text-mako-400 hover:text-mako-400/90 dark:text-[#fdfaf6] dark:hover:text-[#fdfaf6]/90 ",
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      class: {
        bgColor:
          "disabled:bg-transparent disabled:hover:text-bombay-300 bg-red-500",
